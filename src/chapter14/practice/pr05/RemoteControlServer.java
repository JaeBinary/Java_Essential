package chapter14.practice.pr05;
import java.awt.*;
import java.io.*;
import java.net.*;
import javax.swing.*;
...
public class RemoteControlServer extends JFrame {
    ...
    private void setupConnection() throws IOException {
        ...
        new RemoteControlServiceThread().start();
    }
    ...
    class RemoteControlServiceThread extends Thread {
        @Override
        public void run() {
            String msg = null;
            while (true) {
                ...
                switch (msg) {
                    ...
                    case "DOWN":
                        ...
                        label.setLocation(x, y + 10);
                        break;
                    default: // 클라이언트로부터 잘못된 지시. 현재는 아무 반응없이 넘어간다.
                }
