 ...
 */
 ...
 package chapter12.example.ex02;                // chapter12 패키지에 속하는 클래스임을 명시
 ...
 public class RunnableTimerEx extends JFrame {
	 public RunnableTimerEx() {
		 setTitle("Runnable을 구현한 타이머 스레드 예제"); 		// 프레임의 제목 설정
	 ...
	 public static void main(String[] args) {
		 new RunnableTimerEx(); // RunnableTimerEx 객체 생성하여 프레임 실행
	 }
 }
